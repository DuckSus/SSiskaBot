...
async def inline_breast_size(query: InlineQuery):
   ...
   # Варианты начала фразы
    intro_phrases = [
        ...
        "У тебя нет сисек).",
        "🍒 У твоей подруги которая перевелась в другую школу {size} размер сисек!",
        ...
        "💀 У твоего внука который здохнет в 50 лет будет {size} размер сисек!",
        "👵 У твоего прадеда транса которая жила ещё во время Иисуса {size} размер сисек!",
        "Пошел нахуй",
        "Сисьски",
    ]
